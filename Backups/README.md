<h2>Script simples para realizar backup dos arquivos de configuração do Zabbix e seu banco de dados MySQL</h2>
...
--------------------------------------------------------------------------
<h3>Igual ao de instalação, esse script foi desenvolvido para trabalhos de testes nas versões 6.0, 6.4 e 7.0</h3>
